...
class ModelServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetCoefs = channel.unary_unary(
                '/modelserver.ModelServer/SetCoefs',
        ...
        self.Predict = channel.unary_unary(
                '/modelserver.ModelServer/Predict',
...
class ModelServer(object):
    ...
    def SetCoefs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modelserver.ModelServer/SetCoefs',
    ...
    def Predict(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modelserver.ModelServer/Predict',
